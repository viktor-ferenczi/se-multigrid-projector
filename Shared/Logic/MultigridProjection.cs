...
namespace MultigridProjector.Logic
{
    ...
    public class MultigridProjection
    {
        ...
        // Defaults to true on the client, configured by the server plugin via PluginSdk.
        // Read through the shared configuration interface (see MultigridProjector.Config).
        public static bool SetPreviewBlockVisuals => PluginConfig.Current.PreviewBlockVisuals;
...
14:37:54.3885 [ERROR]  Multigrid Projector: : System.NullReferenceException: Object reference not set to an instance of an object.
   ...
   at MultigridProjectorServer.Patches.MyProjectorBase_CanBuild.Prefix(MyProjectorBase __instance, MySlimBlock projectedBlock, Boolean checkHavokIntersections, BuildCheckResult& __result)
        ...
        public bool CreateTopPartAndAttach(Subgrid subgrid, MyMechanicalConnectionBlockBase baseBlock)
        {
            ...
            var definitionGroup = new MyCubeBlockDefinitionGroup();
