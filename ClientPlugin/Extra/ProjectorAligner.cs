...
namespace MultigridProjectorClient.Extra
{
    ...
    class ProjectorAligner : IDisposable
    {
        ...
        private static bool Enabled => Config.Current.ProjectorAligner;
